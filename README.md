...
- **数据迁移**：从 OneBot 切换为 QQ 官方机器人后，用户 ID 由 QQ 号变为 openid，原账号与订阅不会自动关联。用户可发送 `#迁移旧数据 你的旧QQ号`，把旧 QQ 号名下的校园卡账号与记录宿舍迁移到当前 openid（该命令仅迁移本人旧数据，请勿填写他人 QQ 号）。
...
| #迁移旧数据 你的旧QQ号 | 群员 | 否 | 私聊/群聊 | 把旧协议下该QQ号的账号与记录宿舍迁移到当前账号 |
